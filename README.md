...
Welcome to **Shopsphere Frontend**, a sleek and minimalistic user interface built with **React.js**. This frontend interacts with the Shopsphere E-commerce API to provide a smooth shopping experience for users.
...
- Visit the About page to see project information, author credit, and a notice that all payment methods are for testing only.
